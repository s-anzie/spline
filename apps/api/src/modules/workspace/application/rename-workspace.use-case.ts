...
export type RenameWorkspaceError = WorkspaceNotFoundError | EmptyWorkspaceNameError | WorkspaceArchivedError;
...
export class RenameWorkspaceUseCase {
  ...
  async execute(input: RenameWorkspaceInput): Promise<Result<Workspace, RenameWorkspaceError>> {
    ...
    try {
      ...
      if (error instanceof EmptyWorkspaceNameError || error instanceof WorkspaceArchivedError) {

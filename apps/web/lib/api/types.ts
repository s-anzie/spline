...
export type ProviderProfile = { id:string; provider:string; capabilities:unknown; promptFormat:unknown; approvalRules:unknown; hookSupport:unknown; sandboxModel:unknown; outputSchema:unknown; available:boolean; manuallyAvailable:boolean; quotaUnavailableUntil:string|null; quotaReason:string|null; createdAt:string; updatedAt:string };
...
export type Notification = { id:string; workspaceId:string; kind:string; scope:string; taskId:string|null; title:string|null; body:string; payload:Record<string,unknown>; linkedEventId?:string|null; createdBy:{type:string;id:string}; createdAt:string; recipients?:NotificationRecipient[] };
